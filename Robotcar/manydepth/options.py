...
class MonodepthOptions:
    def __init__(self):
        ...
        self.parser.add_argument("--day_night_translation_path",
                                 default='/mnt/weilong/datasets/robotcar/translated/night')
        ...
        self.parser.add_argument("--crop_top",
                                 type = int,
                                 default=0)
     ...
     #                             default=[0, 1, 2, 3])
        ...
        self.parser.add_argument("--load_student_weights_folder",
                                 ...
                                 default = "/mnt/codemnt/weilong/syn2real_depth/checkpoints/Robotcar")
