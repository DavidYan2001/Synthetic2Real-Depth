...
class Visualizer:
    ...
    def visualize_depth(self, inv_depth, filename):
        ...
        print(os.path.join(self.evaluation_qualitative_res_path, f"{filename}_inv_depth.jpg"))
    ...
    def visualize_test(self, batch, outputs):
        ...
        # print(imgs.shape)
        # for j, (img, inv_depth, depth_gt_,lowest_cost_) in enumerate(zip(imgs, inv_depths, depth_gt,lowest_cost)):
